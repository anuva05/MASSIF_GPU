...
//unused: constructs the octree table in the device.
//construct octree table
__device__ int *octreeTable;
__global__ void octree_table_construct(int *ds_rates, int *octreeTable, int *numEntries){
